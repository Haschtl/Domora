  ...
  de: {
    translation: {
      ...
      finances: {
        ...
        rentApartmentDescription: "Wohnungsfläche, Kalt-Miete, Nebenkosten und Nebenkosten-QM-Faktor für die ganze WG.",
        rentMineTitle: "Meins",
        ...
        rentColdPerSqmLabel: "Kaltmiete /qm",
        rentTotalMonthlyLabel: "Gesamtmiete (Kalt + Nebenkosten)",
        rentRoomPerSqmWithUtilitiesLabel: "Zimmer (mit Nebenkosten auf Zimmer) /qm",
        rentTotalPerSqmLabel: "Gesamtmiete /qm",
  ...
  en: {
    translation: {
      ...
      finances: {
        ...
        costBreakdownSharedAreaCosts: "Shared-area costs (sqm)",
        ...
        rentApartmentDescription: "Apartment size, base rent, utilities, and utility-to-room-sqm factor for the whole household.",
        rentMineTitle: "Mine",
        ...
        rentColdPerSqmLabel: "Base rent /sqm",
        rentTotalMonthlyLabel: "Total rent (base + utilities)",
        rentRoomPerSqmWithUtilitiesLabel: "Room (with utilities on room-sqm) /sqm",
        rentTotalPerSqmLabel: "Total rent /sqm",
      ...
      settings: {
        ...
        utilitiesPlaceholder: "400",
        utilitiesOnRoomSqmPercentLabel: "Utilities on room-sqm (%)",
        ...
        utilitiesOnRoomSqmPercentError: "Utility room-sqm factor must be between 0 and 100.",
