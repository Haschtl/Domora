  ...
  de: {
    translation: {
      ...
      settings: {
        ...
        pushPreferencesDescription: "Lege fest, welche Pushes du bekommst.",
        pushPreferencesTopics: "Themen",
        pushQuietHoursTitle: "Ruhezeiten",
        pushQuietHoursStart: "Von",
        pushQuietHoursEnd: "Bis",
        pushQuietHoursInvalid: "Bitte Start und Ende setzen (und verschieden lassen).",
        pushPreferencesSave: "Speichern",
        pushPreferencesLoading: "Lade Push-Einstellungen...",
        pushPreferencesHint: "Aktiviere Push, um Einstellungen zu bearbeiten.",
  ...
  en: {
    translation: {
      ...
      settings: {
        ...
        pushPreferencesDescription: "Choose which notifications you receive.",
        pushPreferencesTopics: "Topics",
        pushQuietHoursTitle: "Quiet hours",
        pushQuietHoursStart: "From",
        pushQuietHoursEnd: "To",
        pushQuietHoursInvalid: "Please set start and end (and keep them different).",
        pushPreferencesSave: "Save",
        pushPreferencesLoading: "Loading push preferences...",
        pushPreferencesHint: "Enable push to edit preferences.",
