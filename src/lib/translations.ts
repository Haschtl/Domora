  ...
  de: {
    translation: {
      ...
      finances: {
        ...
        personalBalanceChip: "Dein Saldo: {{value}}",
        ...
        rentApartmentDescription: "Wohnungsfläche und Warm-Miete für die ganze WG.",
        rentMineTitle: "Meins",
        rentMineDescription: "Deine Zimmergröße und dein Gemeinschaftsfaktor.",
        rentOwnerOnlyHint: "Nur Hauptmieter können Wohnungsfläche und Warm-Miete bearbeiten.",
  ...
  en: {
    translation: {
      ...
      finances: {
        ...
        rentApartmentDescription: "Apartment size and warm rent for the whole household.",
        rentMineTitle: "Mine",
        rentMineDescription: "Your room size and your common-area factor.",
        rentOwnerOnlyHint: "Only household owners can edit apartment size and warm rent.",
